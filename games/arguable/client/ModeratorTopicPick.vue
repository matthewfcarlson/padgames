...
const allTopicList = [
    ...
    "Would hunger games be a good idea in real life",
    "Is the death penalty a good way to reduce crime",
    "Should it be illegal to refuse to vaccinate your children",
    "Would a vampire beat a werewolf in a fight",
    "Does the Harry Potter franchise promote witchcraft",
    "Is globalization a bad thing",
    "Should we declare war against _____",
    "Did we really land on the moon",
    "Are comic books better than regular books",
    "Should death metal be prohibited for children under 18",
    "Do video games require any skill to play",
    "Should we make more movies where the bad guys win",
    "Should we end The Oscars",
    "Should Katniss have ended up with Gale instead of Peeta",
    "Are men better at playing video games than women",
    "Are today's artists less talented than artists 50 years ago",
    "Is Elvis secretly alive",
    "Could Jack have fit on the door with Rose in Titanic",
    "Is being a YouTuber a real job",
    "Are concerts too loud",
    "Does social media make our world a better place",
    "Do we need more super hero movies",
    "Do people actually enjoy horror movies",
    "Should be a salary cap for actors",
    "Is Miss Universe a relevant competition",
    "Should all anime be banned",
    "Should it be illegal to make money on a cover song",
    "Is Global climate change the biggest problem we all face",
    ...
    "Are girls weird when they are PMS-ing",
    "Are memes good",
