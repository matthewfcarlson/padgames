<template>
  <div class="container">
    ...
    <div
      v-if="!ready"
    >Think about what you want to do with your strategies. You'll have 30 seconds to think about it. The debate will last 2-4 minutes and will end when the moderator ends the debate.</div>
